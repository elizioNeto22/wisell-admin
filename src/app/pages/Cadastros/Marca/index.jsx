  ...
  return (
    <div>
       <Form.Group className="page-header">
        <h4 className="page-title">Marca</h4>
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb">
            <Link to="/cadastros/marca">
                  ...
                  <tbody>
                    {data?.marcas?.map((item) => (
                      <tr key={item.codigo}>
                        ...
                        <td>{item.registro}</td>
                        <td>
                          <Link to={`/cadastros/marca/edit/${item.codigo}`}>
                        ...
                        <td>
                          <Link to={`/cadastros/marca/clone/${item.codigo}`}>
                        ...
                        <td>
                          <Link to={`/cadastros/${item.codigo}/marca`}>
