...
const CadastroGrupoEconomico = (props) => {
  const { id } = props.match.params
  const isAddMode = !id
  const { data } = useQuery(queries.GRUPOSECONOMICOS)
  ...
  return (
    <div>
      <div className="page-header">
        <h3 className="page-title"> Grupo Econômico </h3>
      </div>
      <nav aria-label="breadcrumb">
        <p className="breadcrumb-item active">Cadastro de grupo econômico</p>
      </nav>
              ...
              <Form.Group className="row">
                ...
                <div className="col-sm-10">
                  <Form.Control
                    ...
                    placeholder="Descrição do grupo econômico"
                    ref={inputDescricao}
...
export default CadastroGrupoEconomico
