...
const GrupoEconomico = () => {
  ...
  const { loading, error, data } = useQuery(queries.GRUPOSECONOMICOS)
  ...
  return (
    <div>
      <Form.Group className="page-header">
        <h4 className="page-title">Grupo Econômico</h4>
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb">
            <Link to="/cadastros/grupoEconomico">
            ...
            <form onSubmit={handleSubmit} className="card-body">
              <Form.Group>
                <div className="input-group">
                  <Form.Control
                    ...
                    placeholder="Pesquisar grupos econômicos"
                    aria-label="Pesquisar grupos econômicos"
              ...
              <div className="table-responsive">
                <table className="table table-striped">
                  ...
                  <tbody>
                    {data?.gruposeconomicos?.map((item) => (
                      <tr key={item.codigo}>
                        <td>{item.codigo}</td>
                        ...
                        <td>{item.registro}</td>
                        <td>
                          <Link to={`/cadastros/grupoEconomico/edit/${item.codigo}`}>
                        ...
                        <td>
                          <Link to={`/cadastros/grupoEconomico/clone/${item.codigo}`}>
                        ...
                        <td>
                          <Link to={`/cadastros/${item.codigo}/grupoEconomico`}>
