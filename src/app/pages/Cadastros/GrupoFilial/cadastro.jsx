  ...
  return (
    <div>
      <div className="page-header">
        <h3 className="page-title">Grupo Filial</h3>
      </div>
      <nav aria-label="breadcrumb">
        <p className="breadcrumb-item active">Cadastro de grupo filial</p>
      </nav>
              ...
              <Form.Group className="row">
                ...
                <div className="col-sm-10">
                  <Form.Control
                    ...
                    placeholder="Descrição do grupo filial"
                    ref={inputDescricao}
              ...
              <Form.Group className="row">
                ...
                <div className="col-sm-10">
                  ...
                  >
                    ...
                    <option value={29}>Grupo Filial: 1</option>
                    <option value={30}>Grupo Filial: 2</option>
                    <option value={31}>Grupo Filial: 3</option>
                    <option value={32}>Grupo Filial: 4</option>
                  </select>
