...
const CadastroTipoUnidade = (props) => {
  ...
  return (
    <div>
      <div className="page-header">
        <h3 className="page-title"> Tipo Filial </h3>
      </div>
      <nav aria-label="breadcrumb">
        <p className="breadcrumb-item active">Cadastro de tipo filial</p>
      </nav>
              ...
              <Form.Group className="row">
                ...
                <div className="col-sm-10">
                  <Form.Control
                    ...
                    placeholder="Descrição do tipo filial"
                    ref={inputDescricao}
...
export default CadastroTipoUnidade
