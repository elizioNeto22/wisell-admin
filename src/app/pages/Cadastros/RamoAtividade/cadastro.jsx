...
const CadastroRamoAtividade = (props) => {
  ...
  return (
    <div>
      <div className="page-header">
        <h3 className="page-title"> Ramo Atividade</h3>
      </div>
      <nav aria-label="breadcrumb">
        <p className="breadcrumb-item active">Cadastro de ramo atividade</p>
      </nav>
              ...
              <Form.Group className="row">
                ...
                <div className="col-sm-10">
                  <Form.Control
                    ...
                    placeholder="Descrição do ramo atividade"
                    ref={inputDescricao}
...
export default CadastroRamoAtividade
