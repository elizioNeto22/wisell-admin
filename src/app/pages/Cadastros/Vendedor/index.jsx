...
const Vendedor = () => {
  ...
  const { loading, error, data } = useQuery(queries.VENDEDORES)
  ...
  return (
    <div>
      <Form.Group className="page-header">
        <h4 className="page-title">Vendedor</h4>
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb">
            <Link to="/cadastros/vendedor">
                  ...
                  <tbody>
                    {data?.vendedores?.map((item) => (
                      <tr key={item.codigo}>
                        ...
                        <td>{item.registro}</td>
                        <td>
                          <Link to={`/cadastros/vendedor/edit/${item.codigo}`}>
                        ...
                        <td>
                          <Link to={`/cadastros/vendedor/clone/${item.codigo}`}>
                        ...
                        <td>
                          <Link to={`/cadastros/${item.codigo}/vendedor`}>
